...
public final class DateTimeUtil {
    ...
    public static final String DATE_PATTERN_LLLDDE = "LLL dd E";
    public static final String DATE_PATTERN_LLLLDDEEEYYYY = "LLLL dd EEE YYYY";
    ...
    public static final SimpleDateFormat DATE_FORMAT_LLLLDDEEEYYYY = new SimpleDateFormat(DATE_PATTERN_LLLLDDEEEYYYY, Locale.getDefault());
    public static final SimpleDateFormat DATE_FORMAT_LLLDDE = new SimpleDateFormat(DATE_PATTERN_LLLDDE, Locale.getDefault());
