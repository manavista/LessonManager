...
public class MemberLessonScheduleListFragment extends Fragment {
    ...
    public static MemberLessonScheduleListFragment newInstance(String param1, String param2) {
        MemberLessonScheduleListFragment fragment = new MemberLessonScheduleListFragment();
